...
def mutual_friends(list_friends):
    ...
    for i in list_friends:
        ...
        result = vk_api.users.get(user_id = i, v=version)
        print(i, result)
...
user_id1 = input('Введите id пользователя 1: ')
user_id2 = input('Введите id пользователя 2: ')
...
list_friends = mutual(user_id1, user_id2)
